...
//--------------------------------------------------
  TFT_set_font_color( MINT );       // define terminal colors
  ...
  //---------------------------------------------
  TFT_touch_area_font_color( MINT,DARKGREY );      // define color for touch font
  TFT_touch_area_font(SWISS30B);                  // set font for touch area
  TFT_touch_area_frame(20,0);                     //set border no. 20
  TFT_touch_area_color(DARKGREY,MINT,DARKGREY, MINT,DARKGREY,MINT);     //set border colors normal and for selection
